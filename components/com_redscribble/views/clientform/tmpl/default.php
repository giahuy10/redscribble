...
<div class="client-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-client"
			  action="<?php echo JRoute::_('index.php?option=com_redscribble&task=client.save'); ?>"
	...
	<?php echo $this->form->renderField('billing_address'); ?>

	<?php echo $this->form->renderField('head_office_phone'); ?>
	...
	<?php echo $this->form->renderField('key_contact_postal_address'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_redscribble&task=clientform.cancel'); ?>"
