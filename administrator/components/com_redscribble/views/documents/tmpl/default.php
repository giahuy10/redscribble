...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_redscribble&task=documents.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_redscribble&view=documents'); ?>" method="post"
			...
			<table class="table table-striped" id="documentList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_DOCUMENTS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_DOCUMENTS_CLIENT', 'a.`client`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_DOCUMENTS_DOCUMENT_NAME', 'a.`document_name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_DOCUMENTS_FILE', 'a.`file`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'documents.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_redscribble&task=document.edit&id='.(int) $item->id); ?>">
				...
				<?php endif; ?>
					...
					<?php
						echo '<a href="' . JRoute::_(JUri::root() . 'images/redscribble/'.$item->file) . '" target="_blank" title="See the file">';
							echo $item->file;
						 ?>
						 </a>
				</td>
