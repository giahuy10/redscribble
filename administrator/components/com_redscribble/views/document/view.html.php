 ...
 * @since  1.6
 */
class RedscribbleViewDocument extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_REDSCRIBBLE_TITLE_DOCUMENT'), 'document.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_redscribble.document', $this->item->id);
		}
