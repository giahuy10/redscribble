...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_REDSCRIBBLE_TITLE_DOCUMENT', true)); ?>
		<div class="row-fluid">
			...
			?>				<?php echo $this->form->renderField('document_name'); ?>
				...
				<input type="hidden" name="jform[file_hidden]" id="jform_file_hidden" value="<?php echo implode(',', (array)$this->item->file); ?>" />
