...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_redscribble&task=types.saveOrderAjax&tmpl=component';
			...
			<table class="table table-striped" id="typeList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_TYPES_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_TYPES_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_TYPES_GROUP', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_redscribble&task=type.edit&id='.(int) $item->id); ?>">
