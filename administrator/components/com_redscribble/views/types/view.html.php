 ...
 * @since  1.6
 */
class RedscribbleViewTypes extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		RedscribbleHelper::addSubmenu('types');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_REDSCRIBBLE_TITLE_TYPES'), 'types.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_redscribble&view=types');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_REDSCRIBBLE_TYPES_NAME'),
		);
	}
