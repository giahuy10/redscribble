...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_redscribble&task=categories.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'categorieList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo JRoute::_('index.php?option=com_redscribble&view=categories'); ?>" method="post"
			...
			<table class="table table-striped" id="categorieList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_CATEGORIES_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_REDSCRIBBLE_CATEGORIES_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_redscribble&task=categorie.edit&id='.(int) $item->id); ?>">
