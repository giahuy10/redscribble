 ...
 * @since  1.6
 */
class RedscribbleViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		RedscribbleHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_REDSCRIBBLE_TITLE_CATEGORIES'), 'categories.png');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/categorie';

		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				JToolBarHelper::addNew('categorie.add', 'JTOOLBAR_NEW');
			...
			{
				JToolBarHelper::editList('categorie.edit', 'JTOOLBAR_EDIT');
			}
		}
		...
		JHtmlSidebar::setAction('index.php?option=com_redscribble&view=categories');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_REDSCRIBBLE_CATEGORIES_NAME'),
		);
	}
